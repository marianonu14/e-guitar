...
const Hero = () => {
    return ( 
        <div className='relative bg-slate-900  w-full h-[80vh] drop-shadow-2xl'>
            <div className='absolute h-full w-full z-10 flex flex-col md:flex-row justify-evenly items-center p-5'>
                ...
                <p className='text-white text-center text-2xl'>Music Instruments, Accessories and Equipment</p>
            </div>
